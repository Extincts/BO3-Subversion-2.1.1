loadarrays()
{
    ...
    level.r_snappable_models = ["Magic Box", "Metal Desk"];
   	level.snappable_models = ["p7_zm_der_magic_box", "p7_desk_metal_old_01_body_rusty"];
	level.snappable_dimensions = strTok("90;24;57;17.5 72;36;54;34", " ");
